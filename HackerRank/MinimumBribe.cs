...
namespace HackerRank
{
    class MinimumBribe
    {
        ...
        static int Return2Or1(int index, int value)
        {
            if (value > index + 3)
            {
        ...
        static void minimumBribes(int[] q)
        {
            ...
            for (var j = 0; j < q.Length; j++)
            {
                if (q[j] == j + 1)
                {
                   ...
                   //OR  if ( numbersFound.Count()> 0 && Enumerable.Range(numbersFound.Min(), numbersFound.Max()).Except(numbersFound).Count() >0 &&  q[j] > Enumerable.Range(numbersFound.Min(), numbersFound.Max()).Except(numbersFound).First())
                ...
                else//q[j] is less than j+1
                {
                    
                    if (q[j] > Enumerable.Range(numbersFound.Min(), numbersFound.Max()).Except(numbersFound).First())
                    {
                        count++;
